...
@interface JianliMainViewController () <ViewPagerDataSource, ViewPagerDelegate,UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate>
@property(nonatomic,assign)BOOL isshow;
@end

@implementation JianliMainViewController
...
- (NSUInteger)numberOfTabsForViewPager:(ViewPagerControllerFourth *)viewPager {
    return 4;
}

- (UIView *)viewPager:(ViewPagerControllerFourth *)viewPager viewForTabAtIndex:(NSUInteger)index {
...
- (UIViewController *)viewPager:(ViewPagerControllerFourth *)viewPager contentViewControllerForTabAtIndex:(NSUInteger)index {
    JianliViewController *supervisorVC = [[JianliViewController alloc]init];
    supervisorVC.selected_mark =index + 1;
    supervisorVC.picture_experience =self.picture_experience;
    supervisorVC.picture_aut =self.picture_aut;
    supervisorVC.picture_service =self.picture_service;
    supervisorVC.picture_level =self.picture_level;
    supervisorVC.priceMin_ =self.priceMin;
    supervisorVC.priceMax_ =self.priceMax;
    UINavigationController *nav = [[UINavigationController alloc]initWithRootViewController:supervisorVC];
    return nav;
}

#pragma mark - ViewPagerDelegate
- (CGFloat)viewPager:(ViewPagerControllerFourth *)viewPager valueForOption:(ViewPagerOption___)option withDefault:(CGFloat)value {
...
- (UIColor *)viewPager:(ViewPagerControllerFourth *)viewPager colorForComponent:(ViewPagerComponent___)component withDefault:(UIColor *)color {
...
- (void)viewPager:(ViewPagerControllerFourth *)viewPager didChangeTabToIndex:(NSUInteger)index {
