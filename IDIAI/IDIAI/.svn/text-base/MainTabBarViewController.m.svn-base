...
- (void)viewDidLoad {
    ...
    IDIAI4NewHomePageViewController *firstvc =[[IDIAI4NewHomePageViewController alloc] init];
...
//    nav_four.tabBarItem=item_four;
   ...
   // self.tabBar.backgroundColor=[UIColor colorWithHexString:@"#FFFFFF" alpha:1.0];
    ...
    self.viewControllers=@[nav_first,navShoppingMallVC,nav_selectedCase,nav_fifth];
