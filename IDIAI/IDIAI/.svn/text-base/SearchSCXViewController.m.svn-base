...
@interface SearchSCXViewController ()<UITextFieldDelegate,LoginViewDelegate>
{
...
@implementation SearchSCXViewController
...
- (void)viewDidLoad {
    ...
    [savelogObj saveLog:@"设计师--搜索" userID:[NSString stringWithFormat:@"%ld ",(long)[[[NSUserDefaults standardUserDefaults] objectForKey:User_ID] integerValue]] modelType:40];
...
-(void)requestDesignerlist{
    ...
    dispatch_async(parsingQueue, ^{
        ...
        NSString *url=[NSString stringWithFormat:@"%@/dispatch/dispatch.action?header={\"cmdID\":\"ID0265\",\"deviceType\":\"ios\",\"token\":\"%@\",\"userID\":\"%@\",\"cityCode\":\"%@\"}&body={\"qualificationRating\":\"-1\",\"sortType\":\"%ld\",\"keyword\":\"%@\",\"requestRow\":\"15\",\"currentPage\":\"%ld\",\"specialtyId\":\"-1\",\"spaceId\":\"-1\",\"workExperience\":\"-1\",\"auth\":\"-1\",\"priceMin\":\"0\",\"priceMax\":\"10000\",\"cityCode\":\"-1\"}",kDefaultUpdateVersionServerURL,string_token,string_userid,[[[NSUserDefaults standardUserDefaults] objectForKey:cityCodeKey] objectForKey:@"cityCode"],(long)selected_mark, [searchBar.text stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceCharacterSet]],(long)self.currentPage+1];
...
//        cell.backgroundView=[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"bg_libiao"]];
    ...
    if([dataArray count]){
            ...
            UIImageView *photo=(UIImageView *)[cell viewWithTag:KButtonTag_phone+indexPath.section];
            if(!photo) photo=[[UIImageView alloc]initWithFrame:CGRectMake(14, 15, 45, 45)];
            photo.tag=KButtonTag_phone+indexPath.section;
            ...
            CGSize size_name=[util calHeightForLabel:obj.designerName width:170 font:[UIFont systemFontOfSize:17]];
...
#warning 只有实名欠缺其他
        ...
        UILabel *offerlbl=(UILabel *)[cell viewWithTag:KButtonTag_phone*2+indexPath.section];
        if(!offerlbl) offerlbl =[[UILabel alloc] initWithFrame:CGRectMake(photo.frame.origin.x+photo.frame.size.width+11, cell.designer_express.frame.origin.y+cell.designer_express.frame.size.height+4, cell.designer_express.frame.size.width, 12)];
        offerlbl.font =[UIFont systemFontOfSize:12];
        offerlbl.tag =KButtonTag_phone*2+indexPath.section;
        ...
        [cell addSubview:offerlbl];
            ...
            UILabel *credibilitylbl=(UILabel *)[cell viewWithTag:KButtonTag_phone*3+indexPath.section];
            ...
            credibilitylbl.tag=KButtonTag_phone*3+indexPath.section;
        ...
        UIImageView *footline =[[UIImageView alloc] initWithFrame:CGRectMake(15, credibilitylbl.frame.size.height+credibilitylbl.frame.origin.y+10, cell.frame.size.width-35, 1)];
        footline.backgroundColor =[UIColor colorWithHexString:@"#f1f0f6"];
        [cell addSubview:footline];
            
            UIImageView *img_dhua=(UIImageView *)[cell viewWithTag:KButtonTag_phone*4+indexPath.section];
            ...
            img_dhua.tag=KButtonTag_phone*4+indexPath.section;
