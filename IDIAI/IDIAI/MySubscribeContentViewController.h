//
//  MySubscribeContentViewController.h
//  IDIAI
//
...
@interface MySubscribeContentViewController : GeneralWithBackBtnViewController <UITableViewDataSource, UITableViewDelegate, PullingRefreshTableViewDelegate> {
